/* EmlogÊó±ê¸üËæÆß²ÊÐÇÐÇÌØÐ§²å¼þ Íú¿¨ÆÌÖ÷Õ¾´î½¨88Ôª|ÍøÖ·£ºhttp://www.2016ka.cn */
...
(function() {
	...
	q(function() {
		...
		window.giffy_bp_0013 = {
			...
			init: function() {
				for (i = 0; i < 1; i++) {
					var j = "http://down.wlhrt.cn/asd2541/html/sbtx/images/subball" + (i + 1) + ".png";
					giffy_bp_0013.ballImageResource[i] = new Image;
					giffy_bp_0013.ballImageResource[i].src = j
				}
				for (i = 0; i < 8; i++) j = "http://down.wlhrt.cn/asd2541/html/sbtx/images/subball" + (i + 1) + ".png", giffy_bp_0013.subBallImageResource[i] =
